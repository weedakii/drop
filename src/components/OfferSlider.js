...
function ImageSlider() {
  return (
    ...
    <Swiper autoplay autoplayDirection={false} 
            dot={<View style={{backgroundColor:'#ccc', width: 10, height: 8,
                borderRadius: 4, marginLeft: 3, marginRight: 3, elevation: 1,            
                marginTop: 3, marginBottom: -3,}} />
            }
            activeDot={<View style={{backgroundColor:'#edaa4b',elevation: 3, width: 20, height: 8,
